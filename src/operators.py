...
if __name__=='__main__':
    ...
    # def padbc(uinner):
    #     # return pad(pad(uinner, [1,0], 'constant', ul), [0,1], 'constant', ur)
    #     # return pad(
    #     #             pad(
    #     #                 pad(
    #     #                     pad(uinner, [1,0], 'constant', uinner[0,0,-1]), 
    #     #                         [0,1], 'constant', uinner[0,0,0])
    #     #                         ,[1,0], 'constant', uinner[0,0,-2]),
    #     #                         [0,1], 'constant', uinner[0,0,1])
    #     return torch.cat((uinner[:,:,-3:],uinner,uinner[:,:,:3]),dim=2)
    ...
    # t=0
    # init = torch.sin(pi*x).reshape(1,1,-1)
    ...
    # result = torch.cat(result,dim=0)
    # torch.save(result,'burgers2.pth')
    # plt.plot(x,u.squeeze(),label='FD')
    # # plt.plot(x,truth(x,t),'--',label='truth')
